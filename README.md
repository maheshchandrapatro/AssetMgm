...
* [CoreUI Free Angular Admin Template](https://github.com/coreui/AssetMGM)
...
- [Download the latest release](https://github.com/coreui/AssetMGM/)
- Clone the repo: `git clone https://github.com/coreui/AssetMGM.git`
...
See [the Releases section of our project](https://github.com/coreui/AssetMGM/releases) for changelogs for each release version.
...
Code released under [the MIT license](https://github.com/coreui/AssetMGM/blob/master/LICENSE).
